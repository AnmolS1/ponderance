...
<NoteFigure src="/marginalia/sonobe-unit-fold.svg" alt="Folding a single Sonobe unit in four steps: crease the midline, fold the edges to the center, fold two opposite corners, yielding a parallelogram unit with a tab and a pocket.">One Sonobe unit, folded from a square: a tab on one end, a pocket on the other.</NoteFigure>
