...
Jagged, stair-stepped edges on a diagonal line — "jaggies" — look like a rendering limitation, and they are, but the real cause is a single idea from signal processing that turns up everywhere once you've seen it.
